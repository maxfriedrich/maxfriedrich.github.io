...
tl;dr: see the code on GitHub: https://github.com/maxfriedrich/uv-lambda-cdk-example
...
See https://github.com/maxfriedrich/uv-lambda-cdk-example for the full code!
